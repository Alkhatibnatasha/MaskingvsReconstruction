...
options["output_dir"] = "../output/road/"
options["model_dir"] = options["output_dir"] + "bert/"
options["model_path"] = options["model_dir"] + "best_bert.pth"

train_vocab_ambient = glob.glob(options["output_dir"]+"train_valid_test/train/*")
test_vocab_attacks = glob.glob(options["output_dir"]+"train_valid_test/test/attacks/*")
test_vocab_ambient = glob.glob(options["output_dir"]+"train_valid_test/test/ambient/*")
...
options["seq_len"] = 64
options["max_len"] = 64 # for position embedding
options["min_len"] = 64
