...
class CANDataset(Dataset):
    def __init__(self, id_corpus, time_corpus, vocab, seq_len, corpus_lines=None, encoding="utf-8", on_memory=True, predict_mode=False, mask_ratio=0.15):
        """
        ...
        self.corpus_lines = len(id_corpus)
    ...
    def __getitem__(self, idx):
        k, t = self.id_corpus[idx], self.time_corpus[idx]
